  ...
  return(
    <div className="bigDiv centerText">
      ...
      {atHome
        ...
        : <Shop burgers={burgers} setBurgers={setBurgers} storeItems={storeItems} setStoreItems={setStoreItems} adjustBpc={adjustBpc}/> 
      }
      <button className="nav" onClick={() => {setAtHome(!atHome)}}>
        {atHome
          ? "🛒 Go to the Shop"
          : "Go back"
        }
